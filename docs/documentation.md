...
- When using _FlashPipe_ in productive pipelines, use an immutable tag (e.g. `3.2.1`) to ensure stability so that the pipeline will not be affected negatively by new version releases.
