...
func TestMessageMapping_CreateUpdateDeployDeleteOauth(t *testing.T) {
	...
	dt := NewDesigntimeArtifact("MessageMapping", exe)

	createUpdateDeployDelete("Integration_Test_Message_Mapping", "Integration Test Message Mapping", "FlashPipeIntegrationTest", dt, t)

}

func TestMessageMapping_CreateUpdateDeployDeleteBasicAuth(t *testing.T) {
	host := os.Getenv("HOST_TMN")
