...
func TestScriptCollection_CreateUpdateDeployDeleteOauth(t *testing.T) {
	...
	dt := NewDesigntimeArtifact("ScriptCollection", exe)

	createUpdateDeployDelete("Integration_Test_Script_Collection", "Integration Test Script Collection", "FlashPipeIntegrationTest", dt, t)
}

func TestScriptCollection_CreateUpdateDeployDeleteBasicAuth(t *testing.T) {
	host := os.Getenv("HOST_TMN")
