...
FLASHPIPE_VERSION=2.7.2-SNAPSHOT
...
export WORKING_CLASSPATH=$WORKING_CLASSPATH:/usr/share/maven/ref/repository/org/apache/logging/log4j/log4j-slf4j-impl/2.17.1/log4j-slf4j-impl-2.17.1.jar
export WORKING_CLASSPATH=$WORKING_CLASSPATH:/usr/share/maven/ref/repository/org/apache/logging/log4j/log4j-api/2.17.1/log4j-api-2.17.1.jar
export WORKING_CLASSPATH=$WORKING_CLASSPATH:/usr/share/maven/ref/repository/org/apache/logging/log4j/log4j-core/2.17.1/log4j-core-2.17.1.jar
