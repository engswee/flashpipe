...
export WORKING_CLASSPATH=$WORKING_CLASSPATH:/usr/share/maven/ref/repository/org/apache/logging/log4j/log4j-slf4j-impl/2.17.0/log4j-slf4j-impl-2.17.0.jar
export WORKING_CLASSPATH=$WORKING_CLASSPATH:/usr/share/maven/ref/repository/org/apache/logging/log4j/log4j-api/2.17.0/log4j-api-2.17.0.jar
export WORKING_CLASSPATH=$WORKING_CLASSPATH:/usr/share/maven/ref/repository/org/apache/logging/log4j/log4j-core/2.17.0/log4j-core-2.17.0.jar
