...
SAP Integration Suite tenant.`,
		PreRunE: func(cmd *cobra.Command, args []string) error {
			...
			switch artifactType {
			case "DataType", "MessageType", "FaultMessageType", "MessageMapping", "ScriptCollection", "Integration", "ValueMapping":
			default:
	...
	artifactCmd.Flags().String("artifact-type", "Integration", "Artifact type. Allowed values: Integration, MessageMapping, ScriptCollection, ValueMapping, DataType, MessageType, FaultMessageType")
